    ...
    <div className="relative h-auto w-auto">
      ...
      <div className="ml-[25vw] mt-[6rem] flex flex-col h-auto w-[75vw] justify-center items-center bg-transparent overflow-x-scroll overflow-y-hidden">
        <div className="flex flex-col h-auto w-auto">
          <h2
            className="font-ibmplexsans text-3xl text-secondary"
            style={{
              fontWeight: 400,
            }}
          >
          ...
          <div className="flex flex-col w-[75vw] h-[80vh] scale-75 bg-primary items-center justify-center border-4 border-secondary mt-10 rounded-xl p-0">
        ...
        <div className="flex flex-col w-[75vw] h-[80vh] scale-75 items-center justify-center border-4 border-secondary mt-10 rounded-xl p-0">
          <div className="flex w-[75vw] h-[30vh] bg-transparent items-center justify-center rounded-t-xl space-x-2">
